...
Pod::Spec.new do |s|
  s.name             = 'WWInvoices'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WWInvoices.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Ammad Amjad Tarar/WWInvoices'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ammad Amjad Tarar' => 'ammad.amjad@wework.com' }
  s.source           = { :git => 'https://github.com/Ammad Amjad Tarar/WWInvoices.git', :tag => s.version.to_s }
